      ...
      <header className="sticky top-0 z-50 border-b glass-nav">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-5 py-4 sm:px-8">
          <Link to="/" className="group flex items-center gap-3" aria-label="Murtaza AI Works home">
            <span className="flex h-10 w-10 items-center justify-center rounded-md ink-panel font-display text-sm font-extrabold transition-transform group-hover:-rotate-3">
              MB
            </span>
